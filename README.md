...
1. [Edite este arquivo](https://github.com/formatafacil/artigo-abnt/blob/master/README.md#fork-destination-box).
2. Copie este link `http://146.148.88.138/artigo`, [adicione um webhook](../../settings/hooks/new) copiando o link no campo *Playload*.
